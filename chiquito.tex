...
\geometry{left=7mm,right=7mm,top=20mm,bottom=15mm, headsep =5mm}
\setlength{\columnsep}{10pt}

% Header obligatorio ICPC
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{[UNR] - para la pda elegimos wf}
\fancyhead[R]{\thepage}
\renewcommand{\headrulewidth}{0.4pt}

% Configuración código C++
\lstset{
  language=C++,
...
\subsection{run.sh}
\lstinputlisting[language=bash]{src/run.sh}
\subsection{comp.sh}
\lstinputlisting[language=bash]{src/comp.sh}
\subsection{Makefile}
...
\lstinputlisting{src/estructuras/li_chao_tree.cpp}
...
\subsection{Phi y Orden}
\lstinputlisting{src/matematica/phi_orden.cpp}
\subsection{Möbius}
\lstinputlisting{src/matematica/mobius.cpp}
...
\lstinputlisting{src/geometria/halfplanes.cpp}
...
\lstinputlisting{src/strings/aho_corasick.cpp}
...
\lstinputlisting{src/grafos/arborescence.cpp}
\subsection{Blossom}
\lstinputlisting{src/grafos/blossom.cpp}
...
\lstinputlisting{src/optimizacion/simulated_annealing.cpp}
